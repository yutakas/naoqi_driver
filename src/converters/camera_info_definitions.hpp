...
inline sensor_msgs::CameraInfo createCameraInfoTOP4VGA()
{
  ...
  cam_info_msg.K = boost::array<double, 9>{{ 1112.845054830986, 0, 618.366895338178, 0, 1110.898679730161, 460.592233628776, 0, 0, 1 }};
  ...
  cam_info_msg.P = boost::array<double, 12>{{ 1102.589721679688, 0, 616.271132841983, 0, 0, 1110.291320800781, 458.20143668168, 0, 0, 0, 1, 0 }};
